package com.custom.photoView.TextEdit
...
import com.custom.photoView.util.Utils.calculateInSampleSize

import kotlinx.android.synthetic.main.activity_text_editor.*
import android.graphics.Bitmap
import android.view.MotionEvent
import android.view.View
import com.custom.photoView.ui.ImagePreviewActivity
...
class TextEditorActivity : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.custom.photoView.R.layout.activity_text_editor)
       ...
       // text_preview.setOnTouchListener(this)
        ...
        save.setOnClickListener {
           ...
           // bitmap.recycle()
            ...
            var paint =  Paint()
            paint.color = resources.getColor(com.custom.photoView.R.color.blue)
