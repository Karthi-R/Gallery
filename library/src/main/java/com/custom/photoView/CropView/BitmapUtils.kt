...
import com.custom.photoView.util.FileUtil
...
internal object BitmapUtils {
    ...
    private fun cropBitmapObjectWithScale(
        ...
        var result: Bitmap? = Bitmap.createBitmap(bitmap, rect.left, rect.top, rect.width(), rect.height(), matrix, true)
    ...
    fun resizeBitmap(
            bitmap: Bitmap, reqWidth: Int, reqHeight: Int, options: CropImageView.RequestSizeOptions): Bitmap? {
        try {
            if ((reqWidth > 0
                            && reqHeight > 0
