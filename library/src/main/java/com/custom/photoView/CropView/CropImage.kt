package com.custom.photoView.CropView
...
object CropImage {
    ...
    val CROP_IMAGE_ACTIVITY_RESULT_ERROR_CODE = 204
 ...
 * question](http://stackoverflow.com/questions/32789027/android-m-camera-intent-permission-bug).
    ...
    class ActivityBuilder(
        ...
        fun setRequestedSize(
                reqWidth: Int, reqHeight: Int, options: CropImageView.RequestSizeOptions = CropImageView.RequestSizeOptions.RESIZE_INSIDE): ActivityBuilder {
    ...
    class ActivityResult : CropImageView.CropResult, Parcelable {
        ...
        protected constructor(`in`: Parcel) : super(null,
                `in`.readParcelable<Parcelable>(Uri::class.java.classLoader) as Uri, null,
