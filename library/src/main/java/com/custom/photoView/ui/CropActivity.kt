...
import com.custom.photoView.CropView.CropImageView
import com.custom.photoView.ui.ImagePreviewActivity.Companion.IMAGE_PREVIEW_REQUEST_CODE
import com.custom.photoView.util.FileUtil.getCropCacheFolder
...
class CropActivity : BaseActivity(), com.custom.photoView.CropView.CropImageView.OnSetImageUriCompleteListener, com.custom.photoView.CropView.CropImageView.OnCropImageCompleteListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        hideStatusBar()
        setContentView(com.custom.photoView.R.layout.activity_crop)

        mCropImageView = findViewById(com.custom.photoView.R.id.mCropImageView)
        ...
        if (actionBar != null) {
            val title = if (mOptions != null &&
                ...
                getResources().getString(com.custom.photoView.R.string.crop_image_activity_title)
